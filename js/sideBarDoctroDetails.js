...
document.getElementById("name").innerHTML = doctorsGetter()[findDoctor(pdName,pdCategory)].dName
document.getElementById("cost").innerHTML = doctorsGetter()[findDoctor(pdName,pdCategory)].sCost
