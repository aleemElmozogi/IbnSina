function View() {
    ...
    return {
        ...
        hChoseDoctor: function(doctorsCategory){
            ...
            var paras = document.getElementsByClassName(DOMstrings.doctorOptionListInputs)
            while (paras[0]) {
        ...
        startUpEvent: function(allTotalAppointments){
            todayDate()
            sideBarTotalAppointment(allTotalAppointments())
        }
